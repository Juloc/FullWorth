...
namespace FullWorth.Web.Tests.Validation;
...
public sealed class ProblemExceptionHandlerTests
{
    ...
    public async Task Writes500ProblemWithoutLeakingTheException()
    {
        ...
        var secret = "auth-cookie-signing-key-should-never-surface";
        ...
        Assert.DoesNotContain("signing-key", JsonSerializer.Serialize(problem.ProblemDetails));
    }
