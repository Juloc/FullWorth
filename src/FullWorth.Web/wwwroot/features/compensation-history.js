...
async function deleteEvent(entry){
  if(!await confirmMessage({title:'Änderung löschen',message:`Änderung „${entry.title}“ vom ${fmtDate(entry.effectiveDate)} löschen?`,confirmLabel:'Löschen',cancelLabel:'Abbrechen',destructive:true}))return;
