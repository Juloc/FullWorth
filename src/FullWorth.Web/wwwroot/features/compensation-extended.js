...
function loadProfileIntoCalculator(profile){
  ...
  set('annual-bonus',profile.annualBonus);set('tax-class',profile.taxClass||1);set('tax-class4-factor',profile.taxClass4Factor??1);set('state-code',profile.stateCode||'BW');
