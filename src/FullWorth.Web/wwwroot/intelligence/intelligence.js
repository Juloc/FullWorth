...
async function deleteCredential(id) {
  if (!await confirmMessage({title:'Credential löschen',message:'Credential wirklich löschen?',confirmLabel:'Löschen',cancelLabel:'Abbrechen',destructive:true})) return;
  try {
