...
4. **No module knows another sideways.** What two need belongs to the module it belongs to, or to a
   ...
   word reader the statement import reads with, and `LocalTool`, the one runner for pdftotext,
   pdftoppm, pdfinfo and tesseract that never quotes their stderr). This is not theory — it was
